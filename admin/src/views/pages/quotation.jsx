...
const Quotations = () => {
    ...
    const DetailsBtn = ({ id }) => (
        <button
            className="bg-blue-500 text-white text-sm font-[500] p-2 rounded">
            DETAILS
        </button>
    );
    const rows = [
        ...
        <>
            ...
            <div 
                ...
                <div 
                    ...
                    <SubHeading name={"Create Quotation"} handleOnClick={handleOnClick} />
                    <div
                    ...
                    <EnhancedTable rows={rows} columns={columns} title={"Quotations"} />
                </div>
            </div>
        </>
    );
